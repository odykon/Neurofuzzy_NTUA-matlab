...
The three labs cover three pillars of modern control: **fuzzy rule-based control**, **system identification & regression**, and **numerical optimisation for neural network training**.
